...
public class AdminOrderServlet extends HttpServlet {
    ...
    // Lấy tham số status từ URL (ví dụ: ?status=pending)
   String status = request.getParameter("status");
    ...
    List<Order> list = dao.getAllOrdersAdmin(status, search, page);
    int total = dao.getTotalOrders(status, search);
    ...
    request.getRequestDispatcher("/templates/admin/order.jsp").forward(request, response);
} 
